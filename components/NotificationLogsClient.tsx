...
const STATUS_STYLE: Record<string, string> = {
  ...
  test: "bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400",
};
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-950">
              <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide dark:text-gray-400">Timestamp</th>
              ...
              <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide dark:text-gray-400">Recipient</th>
              ...
              <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide dark:text-gray-400">Status</th>
            </tr>
          </thead>
          <tbody>
            ...
            {filteredLogs.map((log) => (
              <tr key={log.id} className="border-b border-gray-200 last:border-b-0 dark:border-gray-700">
                ...
                <td className="px-4 py-3 text-gray-700 dark:text-gray-200">{log.recipientEmail}</td>
                <td className="px-4 py-3 text-gray-700 max-w-xs truncate dark:text-gray-200">{log.subject}</td>
