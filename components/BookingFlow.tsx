...
export default function BookingFlow({
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        {bookingState.status === "error" && errorMessage && (
          <div className="mx-6 mt-4 bg-red-50 dark:bg-red-900/40 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-lg p-3 text-sm">
            {errorMessage}
          </div>
        )}
        {step !== "confirmed" ? (
          <div className="grid grid-cols-1 md:grid-cols-[280px_1fr]">
            <div className="border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 p-6 flex flex-col gap-4">
              <div className="text-xs font-semibold tracking-wide text-brand-500 uppercase">{project.company}</div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-gray-50 leading-snug">{project.name}</h2>
              ...
              <div className="pt-2">
                ...
                <select
                  ...
                  className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-1.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200"
                >
                  {TIMEZONES.map((z) => (
            ...
            <div className="p-6">
              {step === "calendar" && (
                <div className="grid grid-cols-1 sm:grid-cols-[1fr_200px] gap-6">
                          ...
                          <button
                            ...
                            className={
                              ...
                              (selected
                                ...
                                : "text-gray-700 dark:text-gray-200 hover:bg-brand-50 font-medium")
                            }
                          >
                            {d.getDate()}
                          </button>
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900 dark:text-gray-50 mb-3">
                      {selectedDateObj
                        ? selectedDateObj.toLocaleDateString(undefined, { weekday: "short", month: "short", day: "numeric" })
                        : "Pick a date"}
                    </div>
                    {!selectedDateObj && (
                      <p className="text-sm text-gray-400 dark:text-gray-500">Select a highlighted day to see open times.</p>
                    )}
                    {selectedDateObj && selectedSlots.length === 0 && (
                      <div>
                        {wlSubmitted ? (
                          <p className="text-sm text-green-600 dark:text-green-300 font-medium">You're on the waitlist! We'll email you if a slot opens up.</p>
                        ) : (
                          <div className="space-y-2">
                            <p className="text-sm text-gray-400 dark:text-gray-500">No open times this day. Join the waitlist:</p>
                            <input
                              value={wlName}
                              onChange={(e) => setWlName(e.target.value)}
                              placeholder="Your name"
                              className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-800"
                            />
                            <input
                              value={wlEmail}
                            ...
                            <button
                              ...
                              className="w-full text-sm bg-gray-800 hover:bg-gray-900 disabled:bg-gray-300 dark:disabled:bg-gray-700 text-white font-semibold rounded-lg py-2"
                            >
              ...
              {step === "details" && (
                <div className="max-w-sm mx-auto">
                  ...
                  <h3 className="font-bold text-gray-900 dark:text-gray-50 mb-4">Enter your details</h3>
                  <div className="flex flex-col gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full mt-1 text-sm border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-800"
                      />
                    </div>
                    <div>
                    ...
                    <button
                      ...
                      className="mt-2 w-full bg-brand-500 disabled:bg-gray-300 dark:disabled:bg-gray-700 hover:bg-brand-600 text-white text-sm font-semibold rounded-lg py-2.5 flex items-center justify-center gap-2"
                    >
          ...
          <div className="p-8 flex flex-col items-center text-center">
            ...
            <div className="w-full max-w-sm rounded-xl border-2 border-dashed border-brand-100 bg-brand-50/50 relative dark:border-brand-700 dark:bg-brand-700/20">
              ...
              <div className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-gray-50 dark:bg-gray-950 border-2 border-dashed border-brand-100 dark:border-brand-700" />
              <div className="p-5 text-left">
                <div className="text-xs font-semibold text-brand-500 uppercase tracking-wide mb-1">{project.company}</div>
                <div className="font-bold text-gray-900 dark:text-gray-50 mb-3">{project.name}</div>
                <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200 mb-1.5">
            ...
            <button onClick={resetAll} className="mt-6 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 underline">
