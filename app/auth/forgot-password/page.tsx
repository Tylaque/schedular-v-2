    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          {!submitted ? (
            <>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 text-center mb-1">Forgot your password?</h1>
            ...
            <div className="text-center">
              <div className="rounded-lg bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800 p-4 mb-6">
                <p className="text-sm text-blue-800 dark:text-blue-200 font-semibold">Check your email</p>
