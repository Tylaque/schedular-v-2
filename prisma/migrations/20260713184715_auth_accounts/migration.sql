...
-- CreateEnum
CREATE TYPE "AdminAccountType" AS ENUM ('organizational', 'personal', 'unknown');

-- AlterTable
ALTER TABLE "Admin" ADD COLUMN     "accountType" "AdminAccountType" NOT NULL DEFAULT 'unknown',
